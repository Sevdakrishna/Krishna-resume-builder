...
<main class="form-signin w-100 m-auto text-center my-5">
  <form method="post" action="<?=$action->helper->url('action/signup')?>">
    ...
    <h1 class="h2 mb-3 fw-normal">Create Your New Account </h1>

    <div class="form-floating">
      <input type="name" class="form-control" id="floatingInput" name="full_name" placeholder="Enter Your Name" required>
